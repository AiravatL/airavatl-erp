...
export async function POST(request: Request) {
  ...
  if (!consignerProfileId || !fileName || !mimeType || fileSizeBytes === null || !fileExt) {
    return NextResponse.json({ ok: false, message: "consignerProfileId, fileName, mimeType, fileSizeBytes are required" }, { status: 400 });
  }
